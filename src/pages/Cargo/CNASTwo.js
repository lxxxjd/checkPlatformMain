...
const CreateForm = Form.create()(props => {
  ...
  return (
    ...
    >
      ...
      <FormItem labelCol={{ span: 5 }} wrapperCol={{ span: 15 }} label="二级编码">
...

    {
      ...
      render: (text, record) => (
        <Fragment>
          ...
          &nbsp;&nbsp;
          <a onClick={() => this.goCNASThree(text, record)}>编辑三级分类</a>
        </Fragment>
      ),
    },
  ];
